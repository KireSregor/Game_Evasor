...
# Establecer un pygame, la ventana y el cursor del ratón
pygame.init()
...
sonidoJuegoTerminado = pygame.mixer.Sound('sound\credits-66992.mp3')
pygame.mixer.music.load('sound\musicaFondo.mp3')

# Establecer las imágenes
imagenJugador = pygame.image.load('img\RocketShip.gif')
rectanguloJugador = imagenJugador.get_rect()
imagenVillano = pygame.image.load('img\R.png')
...
while True:
    ...
    while True:  # El ciclo del juego se mantiene mientras se esté jugando
        ...
        # Elimina los villanos que han caído por debajo.
        for v in villanos[:]:
